...
class getEnseignantRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/EnseignantRepository.php';

        return $container->privates['App\\Repository\\EnseignantRepository'] = new \App\Repository\EnseignantRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
