...
return [
    ...
    [ // $staticRoutes
        ...
        '/matiere/add' => [[['_route' => 'matiere_add', '_controller' => 'App\\Controller\\MatiereController::add'], null, null, null, false, false, null]],
        '/matieres' => [[['_route' => 'matiere_list', '_controller' => 'App\\Controller\\MatiereController::list'], null, null, null, false, false, null]],
        '/enseignant/add-matiere' => [[['_route' => 'enseignant_add_matiere', '_controller' => 'App\\Controller\\EnseignantController::addMatiere'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_error/(\\d+)(?:\\.([^/]++))?(*:35)'
